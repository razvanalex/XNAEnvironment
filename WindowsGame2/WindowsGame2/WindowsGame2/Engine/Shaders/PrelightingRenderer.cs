...
namespace Engine.Shaders
{
    public class PrelightingRenderer
    {
            ...
            ContentManager Content)
        {
            ...
            shadowDepthEffect = Content.Load<Effect>("shaders//ShadowDepthEffect");
            shadowDepthEffect.Parameters["FarPlane"].SetValue(shadowFarPlane);

            spriteBatch = new SpriteBatch(GraphicsDevice);
            shadowBlurEffect = Content.Load<Effect>("shaders//GaussianBlur");
        ...
        void drawLightMap()
        {
            ...
            foreach (PPPointLight light in Lights)
            {
                ...
                float dist = Vector3.Distance(Camera.Transform.Translation,
                    light.Position);
